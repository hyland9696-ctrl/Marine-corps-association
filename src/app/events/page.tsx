        ...
        <Container className="grid gap-12 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-sm text-navy/60">
              New to the detachment? Prospective members and guests are always welcome &mdash; just
            ...
            <div className="mt-4 space-y-4">
              {annualEvents.map((e) => (
                <Card key={e.title} className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
                  <div>
